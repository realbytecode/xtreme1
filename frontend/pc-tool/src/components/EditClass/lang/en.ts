const en = {
    ...
    'merge-track': 'Merge Track',
    'merge-track-tooltip': 'Merge this track with another track',
    'merge-help-text': 'Click to select another track to merge with this one',
    'pick-target-track': 'Click on the target track object to merge with',
    'same-track-error': 'Cannot merge track with itself',
    'class-type-mismatch': 'Cannot merge: tracks have different classes or types',
    'frame-overlap-error': 'Cannot merge: tracks overlap in frames {{frames}}',
    'merge-validation-failed': 'Cannot merge: validation failed',
    'confirm-merge': 'Confirm Track Merge',
    'merge-subtitle': 'Merge track "{{from}}" into track "{{to}}"? This will update all objects across all frames.',
    'confirm': 'Confirm',
    'cancel': 'Cancel',
    'merge-success': 'Track merged successfully',
    'merge-error': 'Merge failed. Please try again.',
    // Split
    'split-title': 'Split',
